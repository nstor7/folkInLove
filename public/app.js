...
exports.default = function (producto) {
  var el = (0, _yoYo2.default)(_templateObject, producto.imagenFull, producto.imagenCel, producto.alt, producto.nombre, producto.subtitulo, producto.opciones.map(function (opcion) {
...
module.exports = [{
  ...
  descripcion: yo(_templateObject8),
  extra2: yo(_templateObject9)
}, {
