...
module.exports = [{
  ...
  extra: yo(_templateObject4, vestuario.nombre)
}, {
  nombre: 'Pollera Congo',
  url: 'Pollera-Congo',
  ...
  reseña: yo(_templateObject8),
  antecedentes: yo(_templateObject9),
  ...
  descripcion: yo(_templateObject10)
}, {
  nombre: 'La Camisilla',
  url: 'Camisilla',
  ...
  reseña: yo(_templateObject11),
  antecedentes: yo(_templateObject12),
  ...
  descripcion: yo(_templateObject13)
}];
