...
function joyero(vestuario) {
  if (vestuario.joyero) {
    return (0, _yoYo2.default)(_templateObject, vestuario.joyeroImagen, vestuario.joyeroImagen, vestuario.nombre, vestuario.joyero.map(function (joya) {
      return (0, _yoYo2.default)(_templateObject2, joya);
    }));
  }
}
module.exports = function (vestuario) {
  var el = (0, _yoYo2.default)(_templateObject3, vestuario.portadaImagen, vestuario.portadaImagen, vestuario.nombre, vestuario.nombre, vestuario.reseña, vestuario.antecedentes, vestuario.generalImagen, vestuario.general, vestuario.descripcion, joyero(vestuario));
  return el;
};
