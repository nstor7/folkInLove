...
export default function About(){
  return(
    <section className="inicioAbout completa">
      <article className="aboutTexto mitad blanco">
        <hgroup>
      ...
      <img src="images/moneda-coronada-full.jpg" alt="Joya de la Pollera, Moneda Coronada" className="aboutImagen mitad foto"/>
    </section>
