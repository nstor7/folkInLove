...
export default function Identidad(){
  return (
    <div className="inicioIdentidad">
    <article className="identidadImagenes">
      <a href="/vestuarios/Gala-Ocuena" className="identidadImagen  tercio">
        <picture >
          <source media="(min-width: 800px)" srcSet="images/pollera-gala-ocu-identidad-full.jpg"/>
          <img src="images/pollera-gala-ocu-identidad-cel.jpg" alt="Pollera de Gala Ocueña, traje tipico de la región de azuero, Panama" className=" tercio identidadFotos"/>
        </picture>
        
        <div className="identidadInfo negroTrans">
          <hgroup>
      ...
      <a href="/vestuarios/Pollera-Congo" className="identidadImagen tercio">
        <picture>
          <source media="(min-width: 800px)" srcSet="images/pollera-congo-identidad-full.jpg"/>
          <img src="images/pollera-congo-identidad-cel.jpg" alt="Pollera Congo, traje tipico de la región de Colón, Panama" className=" tercio identidadFotos"/>
        </picture>
        <div className="identidadInfo negroTrans">
          <hgroup>
            <h5>Pollera Congo</h5>
      ...
      <a href="/vestuarios/Pollera-De-Lujo" className="identidadImagen identidad1 tercio">
        <picture>
          <source media="(min-width: 800px)" srcSet="images/pollera-lujo-losantos-identidad-full.jpg"/>
          <img src="images/pollera-lujo-losantos-identidad-cel.jpg" alt="Pollera de lujo santeña, traje tipico de la región de azuero, Panama" className=" tercio identidadFotos"/>
        </picture>
        <div className="identidadInfo negroTrans">
          <hgroup>
    ...
    <article className="identidadTexto completa blanco">
      <hgroup>
