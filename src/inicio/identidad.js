...
module.exports = yo`
  <div class="inicioIdentidad" itemscope itemtype="http://schema.org/Article">
    <article class="identidadImagenes">
      <a href="/vestuarios/Gala-Ocuena" class="identidadImagen  tercio">
        <picture >
          ...
          <img itemprop="image" src="images/pollera-gala-ocu-identidad-cel.jpg" alt="Pollera de Gala Ocueña, traje tipico de la región de azuero, Panama" class=" tercio identidadFotos">
        </picture>
      ...
      <a href="/vestuarios/Pollera-Congo" class="identidadImagen tercio">
        <picture>
          ...
          <img itemprop="image" src="images/pollera-congo-identidad-cel.jpg" alt="Pollera Congo, traje tipico de la región de Colón, Panama" class=" tercio identidadFotos">
        </picture>
        <div class="identidadInfo negroTrans">
          <hgroup>
            <h5>Pollera Congo</h5>
      ...
      <a href="/vestuarios/Pollera-De-Lujo" class="identidadImagen identidad1 tercio">
        <picture>
          ...
          <img itemprop="image" src="images/pollera-lujo-losantos-identidad-cel.jpg" alt="Pollera de lujo santeña, traje tipico de la región de azuero, Panama" class=" tercio identidadFotos">
        </picture>
        <div class="identidadInfo negroTrans">
          <hgroup>
    ...
    <article itemprop="articleBody" class="identidadTexto completa blanco">
      <hgroup>
        <h2 itemprop="name">Origen de la Identidad del Panameño</h2>
